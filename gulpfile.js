...
gulp.task('sass', function() {
  ...
  return gulp
    .src(folderAsset + '/dynamic/scss/main.scss')
    .pipe(sass({
...
gulp.task('vendor-css', function() {
  return gulp
    .src(['node_modules/jquery-asPieProgress/dist/css/asPieProgress.min.css'])
...
gulp.task('particles', function() {
  gulp
    .src(folderAsset + '/dynamic/js/particles.json')
    .pipe(gulp.dest(folderAsset + '/static/js/'));
  return gulp
...
gulp.task('fonts', function() {
  gulp
    .src(folderAsset + '/dynamic/fonts/*')
    .pipe(gulp.dest(folderAsset + '/static/fonts/'));
  gulp
    .src('node_modules/mdi/fonts/*')
    .pipe(gulp.dest(folderAsset + '/static/fonts/'));
  gulp
    .src('node_modules/mdi/css/materialdesignicons.min.*')
    .pipe(gulp.dest(folderAsset + '/static/css/'));
  return gulp
    .src(bootstrapDir + '/assets/fonts/bootstrap/*')
    .pipe(gulp.dest(folderAsset + '/static/fonts/'));
});
...
gulp.task('favicon-inject', function() {
  return gulp
    .src([folderTemplate + '/partial/favicon.tmpl'])
...
gulp.task('run-server', function(cb) {
  ...
  runningServer = child.exec(
    '. venv/bin/activate; export PYTHONPATH=`pwd`; python -m kqueen_ui',
...
// Init - every task
gulp.task('build', [
  'sass', 'javascript-all', 'vendor-js', 'vendor-css', 'fonts', 'images', 'favicon'
]);
